<!-- Navbar-->
      <header class="main-header hidden-print"><a class="logo" href="<?php echo base_url(); ?>">RS.Humana Prima</a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href=""><i class="fa fa-plus-circle"></i><span> Input Data</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url('c_guru/nilai'); ?>"><i class="fa fa-medkit"></i> Obat</a></li>
            ...
            <li><a href="<?php echo base_url('c_guru/tampil_restock');?>"><i class="fa fa-list"></i><span>List Inventory re-Stock</span></a></li>
          </ul>
        </section>
      </aside>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="panel panel-primary">
                ...
                <div class="panel-body"><p style="font-size: 18px;" align="justify">Halaman ini adalah halaman dashboard staff logistik. Segala fitur yang terdapat di dalamnya bertujuan untuk mengakomodir divisi logistik dalam menjalankan tupoksinya.</p></div>
              </div>
            </div>
          </div>
        </div>
