			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<?php 
						echo form_open_multipart('c_guru/update_profil');
						...
						<br>
			                ...
			                <div class="form-group">
			                	<label>Status</label>
			                	<?php if($key->status=='6'){ ?>
			                		<input class = "form-control" type="hidden" name="status" value="<?php echo $key->status;?>" readonly>
			                ...
			                <div class="form-group">
			                	...
			                	<?php if( $key->role =='1'){ ?>
			                		<input class = "form-control" type="hidden" name="bagian" value="<?php echo $key->role;?>" readonly>
			                		<input class = "form-control" type="text" value="Guru" readonly>
			                	<?php }elseif( $key->role == '2'){ ?>
			                		<input class = "form-control" type="hidden" name="bagian" value="<?php echo $key->role;?>" readonly>
			                		<input class = "form-control" type="text" value="Tata Usaha" readonly>
			                	<?php }else{ ?>
			                		<input class = "form-control" type="hidden" name="bagian" value="<?php echo $key->role;?>" readonly>
			                		<input class = "form-control" type="text" value="Guru/Pengajar" readonly>
			                	<?php } ?>
