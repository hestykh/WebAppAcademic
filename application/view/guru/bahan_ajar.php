                    ...
                    <table id="simple-table" class="table  table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo anchor('c_guru/materi_pertemuan/'.$mpl->kode_kbm,'Detail',array('class'=>'btn btn-primary btn-sm'));?> &nbsp <?php echo anchor('c_guru/form_upload_materi/'.$mpl->kode_kbm,'Upload',array('class'=>'btn btn-primary btn-sm'));?></td>
