    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">Halaman Input Mata Pelajaran</h3>
                <form action="<?php echo base_url('c_kurikulum/input_mapel'); ?>" method="post">
                  <div class="form-group">
                    <div class="form-group">
                      <label>Kode Mapel</label>
                      <input class="form-control" type="text"  name="kode_mapel" required>
                    </div>
                    <div class="form-group">
