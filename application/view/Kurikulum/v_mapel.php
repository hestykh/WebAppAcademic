                    ...
                    <table class="table table-striped table-bordered data" id= "simpleTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo anchor('c_kurikulum/form_edit_mapel/'.$m->kode_mapel,'Edit',array('class'=>'btn btn-primary btn-sm')).' | '.anchor('c_kurikulum/delete_mapel/'.$m->kode_mapel,'Hapus',array('class'=>'btn btn-danger btn-sm'))?></td>
                      </tr>
                      <?php
                          $no++;
                      }
