    ...
    <div class="wrapper">
      <div class="content-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">Lihat Data Pengajaran</h3>
              <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <div class="row">
                    ...
                    <table class="table table-striped table-bordered data" id= "simpleTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo anchor('c_kurikulum/form_edit_pengajaran/'.$s->kode_pengajaran,'Edit',array('class'=>'btn btn-primary btn-sm'))?></td>
                          <td><?php echo anchor('c_kurikulum/delete_pengajaran/'.$s->kode_pengajaran,'Hapus',array('class'=>'btn btn-danger btn-sm'))?></td>
                      </tr>
                      <?php
                          $no++;
                      }
