    ...
    <div class="wrapper">
      <div class="content-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">Input Data Siswa Kelas </h3>
              <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <div class="row">
                  <div class="col-xs-12">
                    <form action="<?php echo base_url('c_kurikulum/input_siswaKelas');?>" method="post">
                      <table class="table table-striped table-bordered data" id= "simpleTable">
                        ...
                        <tbody>
                          <?php
                          foreach ($siswaKls as $s) { ?>
                          <tr>
                            <td><input type="checkbox" name="pilih|<?php echo $s->nis;?>"></td>
                            <td><?php echo $s->nis;?></td>
                            <td><?php echo $s->nama;?></td>
                            <td><?php echo $s->agama;?></td>
                            <td><?php echo $s->jenis_kelamin;?></td>
                            <td><?php echo $s->tahun_masuk;?></td>
                            <input type="hidden" name="kode_ta" value="<?php echo $this->session->userdata('kode_ta');?>">
                            <input type="hidden" name="kode_kelas" value="<?php echo $this->session->userdata('kode_kelas');?>">
                          </tr>
                          <?php
                          } ?>
                        </tbody>
