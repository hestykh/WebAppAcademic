					...
					<div class="card">
						...
						<br>
							...
							<div class="form-group">
			                    ...
			                    <input class="form-control" type="text" placeholder="Kode Guru" name="kode_guru" value="<?php echo $key->kode_guru;?>" required><small>3 Huruf Kapital Uniq. Contoh: XYZ, FGH, dan lainnya..</small>
			                </div>
			                <div class="form-group">
			                	<label>Nama</label>
			                ...
			                <div class="form-group">
			                	<label>NIP</label>
			                	<input class="form-control" type="text" placeholder="NIP" name="nip" value="<?php echo $key->nip;?>" required>
			                </div>
			                <div class="form-group">
			                	<label>Status</label>
			                ...
			                <?php echo anchor('c_kurikulum/v_dataguru','Back',array('class'=>'btn btn-primary'))?>
