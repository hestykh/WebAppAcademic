	...
	<div class="wrapper">
		<div class="content-wrapper">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<h3 class="card-title">Form Edit Data kbm</h3>
						<div class="form-group">
						<?php echo form_open_multipart('c_kurikulum/update_kbm');?>
							<?php foreach ($kbm as $x) { ?>
							<input type="hidden" name="kode_kbm" value="<?php echo $x->kode_kbm;?>">
							...
							<div class="col-lg-10">
								<select class = "form-control" type="text" name="kode_mapel">
									<option value="<?php echo $x->kode_mapel; ?>"><?php echo $x->nama_mapel; ?></option>
									  <?php foreach($kode_mapel as $row){ ?>
							...
							<div class="col-lg-10">
           					...
           					<?php echo anchor('c_kurikulum/v_data_kbm','Back',array('class'=>'btn btn-primary'))?>
