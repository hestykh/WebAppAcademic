                    ...
                    <table class="table table-striped table-bordered data" id= "simpleTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo anchor('c_kurikulum/form_edit_kelas/'.$k->kode_kelas,'Edit',array('class'=>'btn btn-primary btn-sm')).' | '.anchor('c_kurikulum/delete_kelas/'.$k->kode_kelas,'Hapus',array('class'=>'btn btn-danger btn-sm'))?></td>
                      </tr>
                      <?php
                          $no++;
                      }
