    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">Halaman Input Pengajaran</h3>
        <form action="<?php echo base_url('c_kurikulum/input_data_pengajaran'); ?>" method="post">
          <div class="form-group">
              <label class="col-lg-2 control-label" for="select">Pilih Tahun Ajaran</label>
            <div class="col-lg-10">
             <select class="form-control" id="select" name="kode_ta" value="kode_ta">
            ...
            <div class="col-lg-10">
             <select class="form-control" id="select" name="kode_dataMapel">
              <?php foreach($kode_dataMapel as $m){ ?>
                <option value="<?php echo $m->kode_dataMapel; ?>"><?php echo $m->kode_dataMapel;?> - <?php echo $m->nama_mapel; ?></option>
              <?php } ?>
             </select>
             <br>
            </div>
