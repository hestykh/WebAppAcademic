                  ...
                  <div class="col-xs-12">
                    <table class="table table-striped table-bordered data" id= "simpleTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $no;?></td>
                          <td><?php echo $s->kode_kbm;?></td>
                          <td><?php echo $s->nama;?></td>
                          <td><?php echo $s->nama_mapel;?></td>
                          <td><?php echo $s->tahun_ajaran;?></td>
                          <td><?php echo $s->nama_kelas;?></td>
                          <td><?php echo $s->nama_semester;?></td>
                          <td><?php echo anchor('c_kurikulum/form_edit_kbm/'.$s->kode_kbm,'Edit',array('class'=>'btn btn-primary btn-sm')).' | '.anchor('c_kurikulum/delete_kbm/'.$s->kode_kbm,'Hapus',array('class'=>'btn btn-danger btn-sm'))?></td>
                      </tr>
                      <?php
                          $no++;
                      }
