			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<?php echo form_open_multipart('c_siswa/update_siswa');?>
							<?php foreach ($y as $x) {?>
							...
							<div class="form-group">
								<label>NIS</label>
								<input class="form-control" type="text" placeholder="NIS" name="nis_baru" value="<?php echo $x->nis;?>" required readonly>
		                    </div>
							<div class="form-group">
								<label>Nama</label>
								<input class = "form-control" type="text" value="<?php echo $x->nama;?>" name="nama" required="required" readonly>
							</div>
							<div class="form-group">
								<label>Agama</label>
							...
							<div class="form-group">
			                	<label>Status</label>
			                	<?php if($x->status=='6'){ ?>
			                		<input class = "form-control" type="hidden" name="status" value="<?php echo $x->status;?>" readonly>
			                		<input class = "form-control" type="text" value="Aktif" readonly>
			                	<?php }else{ ?>
			                		<input class = "form-control" type="hidden" name="status" value="Non Aktif"<?php echo $x->status;?> readonly>
			                		<input class = "form-control" type="text" value="Non Aktif" readonly>
			                	<?php } ?>
			                	<!-- <div class="animated-radio-button">
			                		<label>
			                			<input type="radio" name="status" value="6" <?php echo ($x->status=='6')?'checked':'';?>><span class="label-text" readonly>Aktif</span>
			                		</label>
			                	</div>
			                	<div class="animated-radio-button">
			                		<label>
